...
##截图预览
![](/content/images/2017/07/insight1.png)
![](/content/images/2017/07/insight2.png)
![](/content/images/2017/07/insight3.png)
...
```
==注意：bitcoind编译的时候，zmq环境是选装的，但是要使用bitcore，zmq是必装的，没装的滚回去装吧～==<br>
*另外，本地调试也是没问题的,看着办吧*
### 安装*Node.js*
